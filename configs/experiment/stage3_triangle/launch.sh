#!/bin/bash
# ============================================================================
# Stage 3 — triangle multiplicative update (AF2 Alg. 11/12).
# Green light (base.yaml): P@L_long ep10 ≥ 0.60.
#
# Usage:
#   ./configs/experiment/stage3_triangle/launch.sh              # submit all jobs
#   ./configs/experiment/stage3_triangle/launch.sh --dry-run    # print sbatch commands
# ============================================================================
...
echo "================================================"
echo " Stage 3 — Triangle multiplicative update"
